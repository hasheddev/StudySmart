...
android {
    namespace = "com.hasheddev.studysmart"
    compileSdk = 34
...
dependencies {
    ...
    implementation("androidx.compose.presentation:presentation")
    implementation("androidx.compose.presentation:presentation-graphics")
    implementation("androidx.compose.presentation:presentation-tooling-preview")
